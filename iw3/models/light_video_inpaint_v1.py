...
from nunif.modules.attention import WindowGMLP2d, WindowMHA3d, WindowScoreBias3d
...
class MHA3DBlock(nn.Module):
    def __init__(self, in_channels, window_size, mlp_ratio=1, kernel_size=3, shift=False):
        super().__init__()
        num_heads = max(in_channels // 32, 2)
        self.window_size = window_size
        self.mha = WindowMHA3d(in_channels, num_heads=num_heads, window_size=window_size, shift=shift)
        self.relative_bias = WindowScoreBias3d(window_size)
...
class LightVideoInpaintV1(I2IBaseModel):
    ...
    def __init__(self):
        ...
        self.enc2 = nn.Sequential(
            ...
            MHA3DBlock(C2, window_size=4, shift=True),
            MHA3DBlock(C2, window_size=4, shift=False),
