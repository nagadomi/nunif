...
python -m iw3 -y -i ${TEST_DIR} -o ${OUTPUT_DIR} --depth-model Any_S --metadata --video-codec ${H265_ENC} ${HWACCEL}
...
# keyframe
python -m iw3.cli -y -i ${TEST_VIDEO} -o ${OUTPUT_DIR} --depth-model Any_S --keyframe ${HWACCEL}
